		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<h2 class="title"><a href='/news/<?php echo $newsItem['id_news'] ;?>'><?php echo $newsItem['article'].' # '.$newsItem['id_news'];?></a></h2>
						<p class="meta">Posted by <a href="#"><?php echo $newsItem['article'];?></a>
							&nbsp;&bull;&nbsp; <a href='/news/<?php echo $newsItem['id_news'] ;?>' class="permalink"> Full article</a></p>
						<div class="entry">
